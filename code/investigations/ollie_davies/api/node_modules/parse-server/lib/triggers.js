...
function runLiveQueryEventHandlers(data) {
  var applicationId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _node2.default.applicationId;

  if (!_triggerStore || !_triggerStore[applicationId] || !_triggerStore[applicationId].LiveQuery) {
    return;
  }
  _triggerStore[applicationId].LiveQuery.forEach(function (handler) {
    return handler(data);
  });
}