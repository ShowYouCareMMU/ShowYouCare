...
var ParseServer = function () {
  function ParseServer(options) {
    _classCallCheck(this, ParseServer);

    injectDefaults(options);

    var _options$appId = options.appId,
        appId = _options$appId === undefined ? (0, _requiredParameter2.default)('You must provide an appId!') : _options$appId,
        _options$masterKey = options.masterKey,
        masterKey = _options$masterKey === undefined ? (0, _requiredParameter2.default)('You must provide a masterKey!') : _options$masterKey,
        cloud = options.cloud,
        javascriptKey = options.javascriptKey,
        _options$serverURL = options.serverURL,
        serverURL = _options$serverURL === undefined ? (0, _requiredParameter2.default)('You must provide a serverURL!') : _options$serverURL,
        _options$__indexBuild = options.__indexBuildCompletionCallbackForTests,
        __indexBuildCompletionCallbackForTests = _options$__indexBuild === undefined ? function () {} : _options$__indexBuild;
    ...
    var allControllers = controllers.getControllers(options);

    var loggerController = allControllers.loggerController,
        databaseController = allControllers.databaseController,
        hooksController = allControllers.hooksController;
  ...
  _createClass(ParseServer, [{
    ...
    key: 'promiseRouter',
    value: function promiseRouter(_ref2) {
    ...
    key: 'start',
    value: function start(options, callback) {
      var parseServer = new ParseServer(options);
    ...
    key: 'verifyServerUrl',
    value: function verifyServerUrl(callback) {
...
function injectDefaults(options) {
  Object.keys(_defaults2.default).forEach(function (key) {
...
function configureListeners(parseServer) {
  ...
  var destroyAliveConnections = function destroyAliveConnections() {
