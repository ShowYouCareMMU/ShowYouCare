...
var ClassesRouter = exports.ClassesRouter = function (_PromiseRouter) {
  ...
  _createClass(ClassesRouter, [{
    ...
    value: function handleFind(req) {
      ...
      var options = ClassesRouter.optionsFromBody(body);
    ...
    value: function handleGet(req) {
      ...
      return _rest2.default.get(req.config, req.auth, this.className(req), req.params.objectId, options, req.info.clientSDK).then(function (response) {
        if (!response.results || response.results.length == 0) {
          throw new _node2.default.Error(_node2.default.Error.OBJECT_NOT_FOUND, 'Object not found.');
        }

        if (_this2.className(req) === "_User") {
    ...
    value: function handleDelete(req) {
      return _rest2.default.del(req.config, req.auth, this.className(req), req.params.objectId, req.info.clientSDK).then(function () {
        return { response: {} };
      });
    }
  }, {
    ...
    value: function JSONFromQuery(query) {
      ...
      try {
        for (var _iterator3 = _lodash2.default.entries(query)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    key: 'optionsFromBody',
    value: function optionsFromBody(body) {
      ...
      try {
        for (var _iterator4 = Object.keys(body)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
