...
var ParseLiveQueryServer = function () {
  ...
  _createClass(ParseLiveQueryServer, [{
      ...
      parseWebsocket.on('disconnect', function () {
        ...
        if (!_this4.clients.has(clientId)) {
          (0, _triggers.runLiveQueryEventHandlers)({
            ...
            clients: _this4.clients.size,
            subscriptions: _this4.subscriptions.size,
    ...
    value: function _handleConnect(parseWebsocket, request) {
      ...
      var hasMasterKey = this._hasMasterKey(request, this.keyPairs);
      var clientId = (0, _uuid2.default)();
      var client = new _Client.Client(clientId, parseWebsocket, hasMasterKey);
    ...
    key: '_hasMasterKey',
    value: function _hasMasterKey(request, validKeyPairs) {
