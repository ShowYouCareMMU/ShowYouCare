...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function find(query) {
      ...
      return this._rawFind(query, { skip: skip, limit: limit, sort: sort, keys: keys, maxTimeMS: maxTimeMS, readPreference: readPreference }).catch(function (error) {
        ...
        // Retry, but just once.
        .then(function () {
          return _this._rawFind(query, { skip: skip, limit: limit, sort: sort, keys: keys, maxTimeMS: maxTimeMS, readPreference: readPreference });
        });
      });
    }
  }, {
    ...
    value: function _rawFind(query) {
      ...
      var findOperation = this._mongoCollection.find(query, { skip: skip, limit: limit, sort: sort, readPreference: readPreference });
    ...
    value: function count(query) {
      ...
      var countOperation = this._mongoCollection.count(query, { skip: skip, limit: limit, sort: sort, maxTimeMS: maxTimeMS, readPreference: readPreference });
